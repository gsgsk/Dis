...
touch m1.startup m2.startup m3.startup m4.startup lab.conf lab.dep
...
echo "ifconfig eth0 hw ether c0:cc:cc:cc:cc:cc" > m2.startup
echo "ifconfig eth0 192.168.0.3/29" >> m2.startup
echo >> m2.startup
...
echo "ifconfig eth0 192.168.0.4/29" >> m4.startup
echo >> m4.startup
