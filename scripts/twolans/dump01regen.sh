...
touch m1.startup r.startup m3.startup extm1.startup lab.conf lab.dep
...
echo >> r.startup
echo "ifconfig eth1 10.0.0.1/24" >> r.startup
echo >> r.startup
...
echo "ifconfig eth0 10.0.0.3/24" >> extm1.startup
echo >> extm1.startup
