...
touch m1.startup m2.startup m3.startup m4.startup m5.startup lab.conf lab.dep

#The following commands will input the necessary data into the startup files for each machine
echo "ifconfig eth0 hw ether 10:11:11:11:11:11" > m1.startup
echo "ifconfig eth0 192.168.0.4/29" >> m1.startup
echo >> m1.startup
...
echo "ifconfig eth0 hw ether a0:aa:aa:aa:aa:aa" > m3.startup
echo "ifconfig eth0 192.168.0.1/29" >> m3.startup
echo >> m3.startup

echo "ifconfig eth0 hw ether 10:11:11:11:11:11" > m4.startup
echo "ifconfig eth0 10.0.0.2/29" >> m4.startup
echo >> m4.startup

echo "ifconfig eth0 hw ether c0:cc:cc:cc:cc:cc" > m5.startup
echo "ifconfig eth0 192.168.0.3/29" >> m5.startup
echo >> m5.startup
echo "nc -u -l -p 1234 &" >> m5.startup
