...
mkdir m1 r m3 m4 extm1 extm2 

touch m1.startup r.startup m3.startup m4.startup extm1.startup extm2.startup lab.conf lab.dep
...
echo "ifconfig eth0 hw ether b0:bb:bb:bb:bb:bb" > m3.startup
echo "ifconfig eth0 192.168.0.2/29" >> m3.startup
echo >> m3.startup
echo "route add default gw 192.168.0.4" >> m3.startup
echo >> m3.startup

echo "ifconfig eth0 hw ether c0:cc:cc:cc:cc:cc" > m4.startup
echo "ifconfig eth0 192.168.0.3/29" >> m4.startup
echo >> m4.startup
echo "route add default gw 192.168.0.4" >> m4.startup
echo >> m4.startup
echo "nc -u -l -p 1234 &" >> m4.startup
